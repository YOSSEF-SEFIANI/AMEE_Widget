...
export const FORMAT_ITEM: FormatType[] = [
  "pdf",
  "png32",
  "png8",
  "jpg",
...
export const LAYOUT_ITEM: LayoutType[] = [
  "map-only",
  "a3-landscape",
  "a3-portrait",
  "a4-landscape",
...
export const SCALEBAR_UNIT: ScalebarUnitType[] = [
  "Miles",
  "Kilometers",
  "Meters",
  "Feet",
...
export type MapSurroundInfoItemType =
  | "CIMMarkerNorthArrow"
  | "CIMScaleLine"
  | "CIMLegend"
  | "CIMGroupElement"
...
export type IMPrintResultListItemType =
  ImmutableObject<PrintResultListItemType>;
...
export interface PrintTemplateProperties
  extends __esri.PrintTemplateProperties {
  templateId?: string;
...
export type IMPrintTemplateProperties =
  ImmutableObject<PrintTemplateProperties>;

/**
 * Position du diagramme dans le PDF d'impression
 */
...
/**
 * Options d'impression du diagramme (Chart)
 */
...
export type IMChartPrintOptions = ImmutableObject<ChartPrintOptions>;
...
export interface config {
  ...
  // Configuration pour l'impression de diagrammes (Charts)
